...
public class ViewPackage extends JFrame implements ActionListener{
    ...
    JLabel labelpackage,labelperson,labelid,labelnumber,labelphone,labelprice;
    ViewPackage(){
      setBounds(450,200,500,450);
      getContentPane().setBackground(Color.WHITE);
      setLayout(null);
      
      JLabel text=new JLabel("View Your Details");
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==get){
           try{
                String query = "SELECT * FROM bookpackage WHERE username='" + labelusername.getText() + "'";
          //String query="select * from bookpackage where username= '"+labelusername.getText()+"'";
                Conn c=new Conn();
