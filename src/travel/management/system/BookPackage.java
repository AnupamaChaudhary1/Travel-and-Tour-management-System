...
public class BookPackage extends JFrame implements ActionListener{
    Choice cpackage;
    JTextField tfperson,labelid,labelnumber,labelphone;
    String username;
    JLabel labelprice;
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        labelprice.setText("Rs"+cost);
            ...
            try{
                Conn c=new Conn();
                c.stmt.executeUpdate("insert into bookpackage values('"+labelusername.getText()+"','"+cpackage.getSelectedItem() +"','"+tfperson.getText()+"','"+labelid.getText()+"','"+labelnumber.getText()+"','"+labelphone.getText()+"','"+labelprice.getText()+"' )");
